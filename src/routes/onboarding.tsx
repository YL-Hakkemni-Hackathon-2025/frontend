        ...
        <AnimatePresence>
          {showSuccessSheet && (
            <motion.div
              ...
              className="fixed bottom-0 left-0 right-0 max-h-[80+  %] bg-white rounded-t-3xl z-50 flex flex-col items-center px-6 py-4"style={{ paddingBottom: 'max(1rem, env(safe-area-inset-bottom))' }}
            >
